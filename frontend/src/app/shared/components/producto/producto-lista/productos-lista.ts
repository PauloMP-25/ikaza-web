    ...
    cargarCategorias(): void {
        this.categoriaService.obtenerCategoriasActivas().subscribe({
            ...
            error: (error) => {
                ...
                // Si falla el backend, usar categorías hardcoded
                this.categorias = [
                    { idCategoria: 1, nombreCategoria: 'Electrónicos', descripcionCategoria: '', activo: true, fechaCreacion: '', cantidadProductos: 0 },
                    { idCategoria: 2, nombreCategoria: 'Ropa', descripcionCategoria: '', activo: true, fechaCreacion: '', cantidadProductos: 0 },
                    { idCategoria: 3, nombreCategoria: 'Hogar', descripcionCategoria: '', activo: true, fechaCreacion: '', cantidadProductos: 0 }
                ];
            }
        });
    }
