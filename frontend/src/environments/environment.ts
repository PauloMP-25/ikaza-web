...
export const environment = {
    production: false,  // Modo desarrollo: activa mocks y localhost
    ...
    mercadoPagoPublicKey: 'APP_USR-472a9a4e-9afb-49e3-93bc-cfad3c1d0cc8',
    ...
    mercadopago: {
        publicKey: 'APP_USR-472a9a4e-9afb-49e3-93bc-cfad3c1d0cc8', // Tu clave pública de prueba de MP
    },
    ...
    firebaseEmulator: {
        useEmulator: false, // Cambiar a true si usas emuladores
